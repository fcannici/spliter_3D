...
class SPLIT3R_OT_reset_selection_settings(Operator):
    ...
    def execute(self, context):
        ...
        settings.grow_boundary_angle = 17.0
        self.report({"INFO"}, "Selection settings restaurados: Smart 18, Step 10, Grow 1, Boundary 17, Angle-limited OFF.")
        return {"FINISHED"}
...
class SPLIT3R_OT_grow_smart_selection(Operator):
    ...
    def execute(self, context):
        ...
        effective_boundary = min(settings.grow_boundary_angle, 17.0)
